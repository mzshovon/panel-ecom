					...
					<div class="carousel slide" data-ride="carousel" id="single-product-slider">
						<div class="carousel-inner">
							<div class="carousel-item active">
								<img src="images/shop/single-products/product-3.jpg" alt="" class="img-fluid">
							</div>
							<div class="carousel-item">
								<img src="images/shop/single-products/product-2.jpg" alt="" class="img-fluid">
							</div>
							<div class="carousel-item ">
								<img src="images/shop/single-products/product-1.jpg" alt="" class="img-fluid">
							</div>
						</div>
				...
				<div class="single-product-details mt-5 mt-lg-0">
					...
					<form class="cart" action="#" method="post">
						<div class="quantity d-flex align-items-center">
							...
							<a href="cart.html" class="btn btn-main btn-small">Add to cart</a>
						</div>
					</form>
