		...
		<div class="row">
	        <div class="col-md-6 col-lg-4 col-sm-6 mb-5 mb-lg-0 text-center text-sm-left mr-auto">
	          <div class="footer-widget">
	          		<h4 class="mb-4"><img src="{{URL::to('/')}}/public/frontend/images/logo.png" alt="Vaxon." class="img-fluid"></h4>
	        ...
	        <div class="col-md-6 col-lg-3 col-sm-6 text-center text-sm-left">
	        	 <div class="footer-widget">
		          ...
		          <ul class="pl-0 list-unstyled mb-5">
		            <li class="d-lg-flex justify-content-between">Monday-Friday <span>9.00 A.M -11.00 P.M</span></li>
...
<div class="footer-btm py-4 ">
	<div class="container">
		<div class="row ">
	     	<div class="col-lg-6">
	     		<p class="copyright mb-0 ">@2024 Copyright Reserved to <a href="https://ecommartbd.com">Ecom Mart BD</a> &amp; made by <a href="https://ecommartbd.com">Ecom Mart BD</a></p>
	     	</div>
	     	<div class="col-lg-6">
